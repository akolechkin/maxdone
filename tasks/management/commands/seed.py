...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        # BR-26 (Milestone 4): goal templates are now user-authored, not seeded.
        # The old system/global template seed was removed; a single predefined
        # template may return as a separate step later (spec/08).
