...
urlpatterns = [
    ...
    path("task/<str:task_id>/to-inbox/", views.task_to_inbox, name="task_to_inbox"),
    path("task/<str:task_id>/copy/", views.task_copy, name="task_copy"),
    path("task/<str:task_id>/subtask/toggle/", views.subtask_toggle, name="subtask_toggle"),
    path("task/<str:task_id>/subtask/delete/", views.subtask_delete, name="subtask_delete"),
